...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'rounded-2xl border border-border bg-gradient-to-br from-card via-card to-card/80 text-card-foreground shadow-lg transition-all duration-300 hover:shadow-2xl hover:shadow-primary-500/10 backdrop-blur-sm hover:scale-[1.01] group relative overflow-hidden',
